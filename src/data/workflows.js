...
export const workflows = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    lanes: ['Your company', 'SignTime', 'Subcontractor'],
    steps: [
      { n: 1, lane: 'Your company', title: 'Create and send', body: 'Your project team creates the subcontract agreement in your existing system and sends it to the subcontractor through the SignTime API.' },
      { n: 2, lane: 'SignTime', title: 'Route for approval', body: 'The agreement and itemized statement enter SignTime\'s internal approval workflow automatically.' },
      ...
      { n: 5, lane: 'SignTime', title: 'Execute and store', body: 'The executed agreement is stored in the SignTime cloud with a full audit trail.' },
      { n: 6, lane: 'Your company', title: 'Sync back', body: 'The executed document link writes back to your system of record automatically.' },
    ],
...

  {
    ...
    steps: [
      { n: 1, lane: 'Your company', title: 'Prepare and send', body: 'Prepare the lease agreement, required disclosures, and rental application. Set the agent as Signer 1 and the owner as Signer 2, then send.' },
      { n: 2, lane: 'Agent', title: 'Review and delegate', body: 'The agent reviews the package and delegates the tenant portion to the applicant.' },
      { n: 3, lane: 'Tenant', title: 'Sign — and add a co-signer', body: 'The tenant signs. If a co-signer or guarantor is required, the guarantor feature routes it to them without restarting the process.' },
      { n: 4, lane: 'Agent', title: 'Delegate to the owner', body: 'The signed lease is delegated to the property owner for countersignature.' },
      { n: 5, lane: 'Owner', title: 'Countersign', body: 'The owner signs from wherever they are — no office visit, no scanning.' },
      { n: 6, lane: 'Your company', title: 'Store and manage', body: 'The complete executed package is managed in the cloud, searchable and retrievable.' },
    ],
...

  {
    ...
    lanes: ['Your company', 'SignTime', 'Buyer & Seller'],
    steps: [
      { n: 1, lane: 'Your company', title: 'Send the package', body: 'Your agent sends the brokerage agreement, purchase agreement, and required disclosures.' },
      { n: 2, lane: 'SignTime', title: 'Internal approval', body: 'The internal approval workflow runs where required — a second set of eyes before anything leaves the office.' },
      { n: 3, lane: 'Buyer & Seller', title: 'Request signatures', body: 'Once approved, signature requests go out to buyer and seller by email or SMS.' },
      { n: 4, lane: 'Buyer & Seller', title: 'Both parties sign', body: 'Buyer and seller each sign from any device.' },
      { n: 5, lane: 'SignTime', title: 'Execute and store', body: 'The executed transaction file is stored in the SignTime cloud.' },
    ],
...

  {
    ...
    steps: [
      { n: 1, lane: 'Your company', title: 'Bulk send', body: 'Send service applications in bulk with sequential control numbers assigned automatically.' },
      { n: 2, lane: 'Agency network', title: 'Distributed access', body: 'Every agency in your network works from their own account with their own access.' },
      { n: 3, lane: 'Agency network', title: 'Complete and forward', body: 'Agency staff enter property details and forward to the resident.' },
      ...
      { n: 5, lane: 'Your company', title: 'Service begins', body: 'Your service team is notified and onboarding starts immediately.' },
    ],
    renewalNote: {
      title: 'At renewal',
      steps: [
        'Your team sends current service terms to the responsible agency for confirmation',
...

  {
    ...
    lanes: ['QA department', 'SignTime', 'Production lines'],
    steps: [
      { n: 1, lane: 'QA department', title: 'Issue the document', body: 'QA staff issue quality plans, standards, SOPs, audit reports, or inspection certificates from a template.' },
      { n: 2, lane: 'SignTime', title: 'Route by line', body: 'Each document routes to the correct approval chain for its production line.' },
      ...
      { n: 4, lane: 'SignTime', title: 'Retain the record', body: 'Executed documents are retained with a tamper-evident audit trail ready for inspection.' },
    ],
...

  {
    ...
    lanes: ['University', 'SignTime', 'Instructors'],
    steps: [
      { n: 1, lane: 'University', title: 'Build the list', body: 'Export the term\'s instructor list — roughly 300 people — as a CSV.' },
      { n: 2, lane: 'SignTime', title: 'Import and merge', body: 'Import the CSV against your agreement template. Fields populate automatically for every recipient.' },
      { n: 3, lane: 'SignTime', title: 'Send in one click', body: 'All 300 signature requests go out simultaneously.' },
      { n: 4, lane: 'Instructors', title: 'Each instructor signs', body: 'Every instructor receives their own personalized agreement and signs from any device.' },
      { n: 5, lane: 'University', title: 'Track completion', body: 'Track who has signed and who has not from a single dashboard, and remind by email or SMS.' },
    ],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    lanes: ['HR', 'Approvers', 'SignTime', 'Candidate'],
    steps: [
      { n: 1, lane: 'HR', title: 'Prepare the offer', body: 'HR creates the offer approval request with the draft offer letter attached.' },
      { n: 2, lane: 'Approvers', title: 'Internal approval', body: 'HR Director, hiring manager, and department head approve in sequence.' },
      { n: 3, lane: 'SignTime', title: 'Prepare for signature', body: 'Approved documents move into SignTime automatically, with signature fields placed on the offer letter.' },
      ...
      { n: 5, lane: 'HR', title: 'Store and notify', body: 'The executed package is stored and HR is notified. Download to your document system as needed.' },
    ],
...

  {
    ...
    steps: [
      { n: 1, lane: 'Your company', title: 'Send the document', body: 'Your rep sends the quote, service agreement, statement of work, or invoice.' },
      { n: 2, lane: 'Approvers', title: 'Internal approval first', body: 'Before it reaches the client, it routes through internal approval — pricing and terms get a second review.' },
      ...
      { n: 4, lane: 'Client signer', title: 'Delegated to the signer', body: 'They delegate it to the person with signing authority — their director, their CFO, whoever it needs to be. You never had to ask.' },
      { n: 5, lane: 'Your company', title: 'Closed and stored', body: 'The executed agreement is stored and the deal is closed.' },
    ],
...

  {
    ...
    steps: [
      ...
      { n: 2, lane: 'Approvers', title: 'Approval before send', body: 'The document routes to internal approval before it reaches the signer.' },
      ...
      { n: 5, lane: 'Your company', title: 'Archived', body: 'The executed document is stored in the cloud, tagged and searchable.' },
    ],
...

  {
    ...
    lanes: ['Corporate secretary', 'SignTime', 'Directors'],
    variants: [
      {
        title: 'When order matters',
        steps: [
          { n: 1, title: 'Upload the packet', body: 'Upload board minutes and consents; attach files to the signature template.' },
      ...
      },
      {
        ...
        steps: [
          ...
          { n: 2, title: 'Bulk send', body: 'Send to every director at once with long-term signature validation enabled.' },
    ...
    variants: [
      {
        ...
        steps: [
          { n: 1, title: 'Set the signing order', body: 'Sender uploads the document and enables sequential signing.' },
      ...
      },
      {
        ...
        steps: [
          { n: 1, title: 'Turn on internal approval', body: 'Sender enables internal approval and names the approvers.' },
...

  {
    ...
    lanes: ['Sender', 'SignTime', 'Recipients'],
    steps: [
      { n: 1, lane: 'Sender', title: 'Build the template', body: 'Create the agreement once as a template with custom fields for the details that change.' },
      ...
      { n: 3, lane: 'SignTime', title: 'Merge and send', body: 'Every recipient gets their own personalized document. One click.' },
...

  {
    ...
    steps: [
      { n: 1, lane: 'Sender', title: 'Send to your contact', body: 'Send the agreement to the person you actually know at the account.' },
...

  {
    ...
    lanes: ['Salesforce', 'SignTime', 'Customer'],
    steps: [
      ...
      { n: 2, lane: 'SignTime', title: 'Populate and start', body: 'Salesforce field values populate your SignTime template and the workflow begins.' },
      { n: 3, lane: 'SignTime', title: 'Approve internally', body: 'The internal approval workflow runs, fixed per template. A rejection returns it to the sender.' },
...

  {
    ...
    lanes: ['Sender', 'SignTime', 'Signer'],
    steps: [
      { n: 1, lane: 'Sender', title: 'Send by SMS', body: 'Choose SMS instead of email when sending. No email address required.' },
      { n: 2, lane: 'SignTime', title: 'Secure link delivered', body: 'The signer receives a secure document link on their phone.' },
