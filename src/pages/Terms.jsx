...
const TOC_SECTIONS = [
  ...
  { id: 'scanner-storage', title: '8. Scanner Storage Service (ScanTime)' },
      ...
      <Section variant="light">
        <div className="terms-layout">
          ...
          <div className="terms-body">
            ...
            <h2 id="scanner-storage">8. Scanner Storage Service (ScanTime)</h2>
            <p>
              Plans including the ScanTime service have a minimum term of one year, renewing
