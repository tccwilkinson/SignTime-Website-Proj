    ...
    <>
      <section style={{ background: 'radial-gradient(circle at 50% -10%, #DCEAFC 0%, #fff 55%)', padding: '3.5rem 0 3rem' }}>
        <div className="container" style={{ maxWidth: '720px' }}>
          ...
          <TodoFlag>article body not yet written for this slug — content pending</TodoFlag>
        </div>
      </section>

      <section style={{ background: '#fff', padding: '3rem 0 4rem' }}>
        <div className="container" style={{ maxWidth: '720px' }}>
          <div style={{ border: '1px dashed var(--line)', borderRadius: '14px', padding: '32px', textAlign: 'center', color: 'var(--slate)' }}>
            This article template is wired up and routable, but the body copy for this piece hasn't been written yet.
          </div>
