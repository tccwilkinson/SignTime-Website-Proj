...
export default function FeatureDetail() {
  ...
  const featureTitle = titleFromSlug(slug);
          ...
          <div style={{ background: '#fff', border: '1px solid var(--line)', borderRadius: '16px', padding: '2.5rem', boxShadow: 'var(--shadow-subtle)', marginBottom: '3.5rem' }}>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.98rem', color: 'var(--ink)' }}>
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                ...
                <div>
                  <strong>Seamless Integration:</strong> Works out of the box with your existing document templates, PDFs, and Office files.
                </div>
              </li>
              ...
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                <CheckCircle2 size={18} color="var(--emerald)" style={{ flexShrink: 0, marginTop: '3px' }} />
                <div>
                  <strong>Real-Time Tracking:</strong> Receive automatic notifications and status updates as signers complete their steps.
                </div>
              </li>
              ...
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                <CheckCircle2 size={18} color="var(--emerald)" style={{ flexShrink: 0, marginTop: '3px' }} />
                <div>
                  <strong>Mobile &amp; Browser Compatible:</strong> Signers can view and sign on iPhone, Android, iPad, or desktop without downloading an app.
                </div>
              </li>
            </ul>
          </div>
